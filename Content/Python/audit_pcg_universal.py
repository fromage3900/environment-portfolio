...
BASE_EXPECTED_GRAPHS = (
    ...
    std.GRAPH_WALL_IVY,
    std.GRAPH_WALL_MOSS,
    std.GRAPH_WALL_LICHEN,
    std.GRAPH_GREYBOX_MINIMAL,
    std.GRAPH_GREYBOX_STANDARD,
    std.GRAPH_SAKURA_SHOWCASE,
    std.GRAPH_MEADOW_BLOOM,
    std.GRAPH_BLOSSOM_PATH,
    std.GRAPH_LANTERN_GROVE,
    std.GRAPH_GARDEN_RUINS,
    std.GRAPH_PETAL_DRIFT,
    std.GRAPH_MOSS_GROUNDCOVER,
)
