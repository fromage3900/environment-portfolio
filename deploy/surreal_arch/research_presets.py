...
RESEARCH_PRESETS = {
    ...
    "art_deco_lobby_graph": {
        ...
        "description": "Stepped civic facade, geometric panel wall, chevron filigree, cusped portal, promenade ramp",
        "research_ref": "research/artdeco/01_lobby_promenade.md — art_deco_lobby_v1 + ART_DECO graph",
        "group": "CIVIC",
        "graph_id": "ART_DECO",
