...
RESEARCH_PRESETS = {
    ...
    "art_deco_lobby_graph": {
        ...
        "description": "Setback facade, lobby stair, geometric panel, chevron filigree, cusped portal, processional ramp",
        "research_ref": "research/art_deco/01_lobby_promenade.md — art_deco_lobby_v1 + ART_DECO graph (tower-ban)",
        "group": "CIVIC",
        "graph_id": "ART_DECO",
