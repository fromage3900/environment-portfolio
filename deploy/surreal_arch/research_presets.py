...
RESEARCH_PRESETS = {
    ...
    "persian_iwan_courtyard_graph": {
        "label": "Persian Iwan Courtyard",
        "description": "Processional ramp, pointed iwan portal, arabesque screen, riwaq arcade, hypostyle, fountain",
        "research_ref": "research/persian/01_iwan_courtyard.md — persian_iwan_courtyard_v1 + PERSIAN_IWAN",
        "group": "CIVIC",
        "graph_id": "PERSIAN_IWAN",
        "genome_id": "persian_iwan_courtyard_v1",
        "props": dict(
            arch_type="ARCHWAY_ADV",
            archway_style="GOTHIC",
            archway_width=3.2,
            archway_height=4.8,
            archway_depth=1.8,
            material_choice="STONE",
            unit_size=2.0,
            style_genome_id="persian_iwan_courtyard_v1",
        ),
    },
