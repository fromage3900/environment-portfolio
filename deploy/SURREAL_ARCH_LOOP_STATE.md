...
- **`meso_pyramid_courtyard_v1`** genome + **`MESOAMERICAN_PYRAMID`** grammar (7 modules: terraces, ceremonial stair, colonnade pier, arcade, portal, sacred pool)
- **`MESOAMERICAN_PYRAMID`** compose style — pillar corner (no tower), retaining large, fountain sacred
